...
/** Export these so MobileNav can reuse them */
...
export const NAV_ITEMS = [
  ...
  { to: "/services", label: "Services", type: "services" }, // special: expands submenu
  { to: "/memberships", label: "Memberships" },
  { to: "/tbeautyacademy", label: "T Beauty Academy" },
  { to: "/faq", label: "FAQ" },
  { to: "/promo", label: "Promos", badge: "New" },
  { to: "/cherry", label: "Payment Plan with Cherry 🍒" },
...
function ServiceLink({ to, children }) {
  ...
  return (
    <Link
      to={to}
      className={[
        "block rounded px-2 py-[3px] text-[13px] leading-snug",
        active
