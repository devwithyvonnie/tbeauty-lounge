...
export default function FibroblastPage() {
  const defaultTab = SECTIONS[0]?.id ?? "eyes";
    ...
    <div className="py-8">
      ...
      <section className="mx-auto w-[96%] max-w-screen-2xl">
        <div className="relative overflow-hidden rounded-2xl ring-1 ring-black/5">
          <img
            src="/images/services/fibroblast/hero.png"
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="mx-auto w-11/12 max-w-4xl">
              ...
              <p className="mt-4 max-w-2xl text-brand-forest/85">
                A precision-based treatment designed to help tighten and smooth
                the appearance of skin in targeted areas. Pricing is by area—
                your provider will confirm candidacy and a customized plan during
                consultation.
              </p>
          ...
          <article className="mt-4 overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-black/5">
            ...
            <div className="p-4 md:p-5">
              ...
              <p className="mt-4 text-xs text-brand-forest/70">
                Ask about combining areas for a customized plan.
              </p>
            </div>
          </article>
        </section>
