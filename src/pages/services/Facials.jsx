// src/pages/services/Facials.jsx
import MiniFAQAccordion from "../../components/MiniFAQ";

// 🧴 Signature facials (update durations/prices to match your exact menu)
const SIGNATURE_FACIALS = [
  ...
  },
  {
    id: "hydrafacial",
    name: "HydraFacial",
    tagline: "Hydra-dermabrasion treatment for deep cleanse and intense hydration.",
...
// 💎 NEW: HydraDiamond block (structured like microneedling)
    ...
    <div className="mx-auto w-11/12 max-w-5xl py-8">
      ...
      <header>
        ...
        <p className="mt-3 max-w-2xl text-brand-forest/85">
          From calming spa facials to advanced HydraDiamond® and microneedling,
          every treatment is customized to your skin type, concerns, and goals.
        </p>
        ...
        <div className="flex items-baseline justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-brand-forest/80">
              ...
              needs. Times listed include consultation and finishing touches.
            </p>
          </div>
        </div>
      ...
      {/* HYDRADIAMOND BLOCK (structured like microneedling) */}
      <section className="mt-10">
        <div className="flex items-baseline justify-between gap-3">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm text-brand-forest/80">
      ...
      <section className="mt-10">
        <div className="flex items-baseline justify-between gap-3">
          <div>
            <h2 className="text-xl font-semibold text-brand-forest">
              Microneedling &amp; Advanced Collagen
            </h2>
            <p className="mt-1 text-sm text-brand-forest/80">
              For texture, scarring, fine lines, and overall skin rejuvenation.
            </p>
          </div>
        </div>
        ...
        <article className="mt-4 overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-black/5">
          ...
          <div className="p-4 md:p-5">
            ...
            <p className="mt-3 text-xs text-brand-forest/65">
              A consultation is recommended prior to advanced treatments to
              review your skin history, expectations, and pre/post-care.
            </p>
          </div>
        </article>
      </section>
